...
static u8 Report_Physical_Add_Cmd[7] = {0x5F, REPORT_PHYSICAL_ADDRESS, 0x20, 0x00, 0x05};
...
#define     _ms *1000
#define     CEC_NEW_FRAME           (5*(2.4 _ms))
...
#error "please config time input channle"
    ...
    __this->time_id = sys_timer_add(NULL, cec_timer_loop, 30);
