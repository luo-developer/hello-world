...
//                                  fat 文件系统配置                                       //
//*********************************************************************************//
#define CONFIG_FATFS_ENBALE					DISABLE
...
#define TCFG_APP_RECORD_EN				    DISABLE_THIS_MOUDLE//((TCFG_UDISK_ENABLE || TCFG_SD0_ENABLE || TCFG_SD1_ENABLE) && CONFIG_FATFS_ENBALE)
...
#if (DUEROS_DMA_EN || TRANS_DATA_EN || RCSP_BTMATE_EN || RCSP_ADV_EN)
...
//*********************************************************************************//
//是否支持充电盒(作为盒子使用)
#define TCFG_CHARGE_BOX_ENABLE                        ENABLE_THIS_MOUDLE
