...
#define TCFG_APP_RTC_EN					    DISABLE//(TCFG_RTC_ENABLE)
#define TCFG_APP_RECORD_EN				    DISABLE//((TCFG_UDISK_ENABLE || TCFG_SD0_ENABLE || TCFG_SD1_ENABLE) && CONFIG_FATFS_ENBALE)
#define TCFG_APP_SPDIF_EN                   DISABLE//(TCFG_SPDIF_ENABLE)
