...
#define TCFG_EQ_MODE_TAB20                  1
#if TCFG_EQ_MODE_TAB20
#define EQ_SECTION_MAX                            20//eq 段数，最大20
#else
#define EQ_SECTION_MAX                            10//eq 段数，最大20 , drc使能时，段数不可小于4

#endif


#define TCFG_EFFECTS_ENABLE         0           // 混响音效支持配置文件
...
#define TCFG_BT_SNIFF_DISABLE               0   //bt sniff 功能使能
...
//                                  app 配置                                       //
//*********************************************************************************//
#define TCFG_APP_MUSIC_EN				   0//	((TCFG_UDISK_ENABLE || TCFG_SD0_ENABLE || TCFG_SD1_ENABLE) && CONFIG_FATFS_ENBALE)
#define TCFG_APP_LINEIN_EN				  0//	(TCFG_LINEIN_ENABLE)
#define TCFG_APP_FM_EN					  0//  (TCFG_FM_ENABLE)
#define TCFG_APP_PC_EN					  0//  (TCFG_PC_ENABLE)
#define TCFG_APP_RTC_EN					   0// (TCFG_RTC_ENABLE)
#define TCFG_APP_RECORD_EN				   0// DISABLE_THIS_MOUDLE
...
//*********************************************************************************//
#if (TCFG_AUDIO_DAC_CONNECT_MODE == DAC_OUTPUT_FRONT_LR_REAR_LR)
#define DUAL_TO_QUAD_AFTER_MIX        0
#endif
