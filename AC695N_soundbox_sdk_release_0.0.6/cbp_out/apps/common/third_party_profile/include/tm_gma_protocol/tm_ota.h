...
#define MAIN_NUMBER				0X01
#define SECONDARY_NUMBER		0X00
#define REVISION_NUMBER			0X02



#define OTA_CIRCLE_PACKET_SIZE			2		//range:0~15		
#define OAT_ONE_PACKET_MAX_SIZE			0x100
...
void gma_ota_data_receive_timeout_clean(void);
...
uint8_t gma_ota_update_verify_cb(sint32_t (*verify_result_hdl)(int crc_res));
