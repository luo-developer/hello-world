...
/**************************************************************
	moudle:		speech
**************************************************************/
static volatile u16 speech_timer = 0;
static void tm_gma_speech_timeout(void *priv)
{
	GMA_DEBUG("gma speech timeout !!! \n");
...
int gma_hw_start_speech(void)
{
    ...
    if (ai_mic_rec_start() == 0) {
        ...
        speech_timer = sys_timeout_add(NULL, tm_gma_speech_timeout, 8000);
    }
