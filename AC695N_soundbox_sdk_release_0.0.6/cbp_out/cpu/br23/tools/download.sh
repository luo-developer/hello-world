...
if [ -f version ]; then
    host-client -project ${NICKNAME}$2_soundbox -f app.bin version $1.elf br23loader.* uboot* -app_ota_${APP_OTA_EN}
else 
    host-client -project ${NICKNAME}$2_soundbox -f app.bin $1.elf br23loader.* uboot* -app_ota_${APP_OTA_EN}
