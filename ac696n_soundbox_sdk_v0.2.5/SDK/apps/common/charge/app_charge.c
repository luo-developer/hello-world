...
void set_charge_idle_flag(u8 flag)
{
    charge_check_idle = flag;
}
...
static u8 charge_check_idle_query(void)
{
    return charge_check_idle;
}

REGISTER_LP_TARGET(charge_check_lp_target) = {
    .name = "charge_check",
    .is_idle = charge_check_idle_query,
};
