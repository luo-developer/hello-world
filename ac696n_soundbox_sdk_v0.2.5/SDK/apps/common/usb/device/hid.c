...
void hid_test(struct usb_device_t *usb_device)
{
...
#if TCFG_MOUSE_ENABLE
    hid_key.report_id = 0x01;
    hid_key.button1 = 0x00;
    hid_key.button2 = 0x00;
    hid_key.button3 = 0x00;
    hid_key.X_axis = 0x00;
    hid_key.Y_axis = 0x00;

    //画一个正方形
    hid_key.button1 = 0x01;
    tx_count ++;
    if (tx_count <= 20) {
        hid_key.X_axis += 0x10;
        hid_key.Y_axis = 0x00;
    ...
    hid_tx_data((const u8 *)&hid_key, 4);
#else
