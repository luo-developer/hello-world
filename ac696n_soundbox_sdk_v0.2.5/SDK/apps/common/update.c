...
#define UPDATE_VOICE_REMIND					//升级完提示音使能(音箱注意需播放前开PA MUTE)
...
extern void bt_rf_close();
extern void bredr_bd_close();
int _norflash_close(void);
void hci_controller_destory(void);
...
#ifdef DEV_UPDATE_SUPPORT_JUMP			//后台模式需要把蓝牙关掉
