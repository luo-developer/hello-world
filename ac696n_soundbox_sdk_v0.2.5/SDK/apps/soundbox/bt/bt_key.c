...
static const u8 bt_key_rdec_table[KEY_RDEC_NUM_MAX][KEY_EVENT_MAX] = {
    [0] =
    {
        /*SHORT*/ KEY_VOL_UP,
        /*LONG*/  KEY_VOL_UP,
...
u8 __attribute__((weak))bt_key_event_get(struct key_event *key)
{
    if (key == NULL) {
        return KEY_NULL;
    }
    ...
    case KEY_DRIVER_TYPE_RDEC:
        key_event = bt_key_rdec_table[key->value][key->event];
        break;
    default:
        break;
    }
